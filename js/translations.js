const translations = {
  'zh-CN': {
    ...
    'apiKeyVerifiedProceedToGetModels': "API Key 已验证！您现在可以在模型设置中获取可用模型。",
    "fetchAvailableModelsLabel": "获取可用模型：",
    "selectedModelsLabel": "已选模型：",
    "noModelsSelectedHint": "尚未选择任何模型。请先获取并选择模型。",
    "notImplementedYet": "此功能尚未实现。",
    "selectModelsTitle": "选择模型",
    "searchModelsPlaceholder": "搜索模型...",
    "loadingModelsHint": "正在加载模型...",
    "confirmSelectionButton": "确认选择",
    // apiKeyMissingError is already defined but ensuring it's suitable for this context too.
    // Value: "API Key 未设置。请先在模型设置中配置 API Key。" (Existing is fine)
    "fetchModelsError": "获取模型列表失败：{error}",
    "noModelsFoundHint": "未能为您的 API Key 找到兼容的模型。",
    "saveSelectedModelsError": "保存已选模型失败：{error}",
    "selectedModelsSavedSuccess": "已选模型已保存。",
    "configureModelsInSettings": "请在设置中配置可用模型",
    "chatApiKeyMissingError": "API Key 未设置。请先在“设置”中配置后再发送消息。",
    "apiKeyNotConfiguredForHelper": "API Key 未配置。请在 Pagetalk 扩展程序的设置中进行配置。",
    "apiKeyInvalidError": "API Key 无效或权限不足。请在设置中检查您的 Key 或前往 Google AI Studio确认。",
    "errorPrefix": "错误",
    "retryButton": "重试",
    "modelNotFoundErrorHelper": "找不到或无法使用所选模型。请检查您的选择或主设置。",
    "quotaExceededErrorHelper": "API 配额已超出。请检查您的用量限制或稍后再试。",
    "networkErrorHelper": "发生网络错误。请检查您的网络连接并重试。",
    "locationNotSupportedErrorHelper": "您所在地区无法使用此服务。如果合适，请考虑使用VPN或代理。",
    "safetyBlockedErrorHelper": "由于安全设置，请求或响应被阻止。如果可用，请尝试调整措辞或内容过滤设置。",
...
2.  **输入为中文内容**：
  ...
  'en': {
    ...
    'apiKeyVerifiedProceedToGetModels': "API Key verified! You can now fetch your available models in the Model Settings.",
    "fetchAvailableModelsLabel": "Fetch Available Models:",
    "selectedModelsLabel": "Selected Models:",
    "noModelsSelectedHint": "No models selected yet. Please fetch and select models first.",
    "notImplementedYet": "This feature is not implemented yet.",
    ...
    // apiKeyMissingError is already defined but ensuring it's suitable for this context too.
    // Value: "API Key is missing. Please set it up in Model Settings first." (Existing is fine)
    "fetchModelsError": "Error fetching models: {error}",
    "noModelsFoundHint": "No compatible models found for your API Key.",
    "saveSelectedModelsError": "Failed to save selected models: {error}",
    "selectedModelsSavedSuccess": "Selected models have been saved.",
    "configureModelsInSettings": "Please configure models in Settings",
    "chatApiKeyMissingError": "API Key is not set. Please configure it in Settings before sending messages.",
    "apiKeyNotConfiguredForHelper": "API Key is not configured. Please set it in the Pagetalk extension settings.",
    "apiKeyInvalidError": "API Key is not valid or has insufficient permissions. Please check your key in settings or the Google AI Studio.",
    "errorPrefix": "Error",
    "retryButton": "Retry",
    "modelNotFoundErrorHelper": "Model not found or unavailable. Please check your selection or main settings.",
    "quotaExceededErrorHelper": "API quota exceeded. Please check your usage limits or try again later.",
    "networkErrorHelper": "A network error occurred. Please check your internet connection and try again.",
    "locationNotSupportedErrorHelper": "Service not available in your location. Consider using a VPN or proxy if appropriate.",
    "safetyBlockedErrorHelper": "Request or response was blocked due to safety settings. Try rephrasing or adjusting content filters if available.",
